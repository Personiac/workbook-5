...
function findMoviesByDirectorList(director) {
...
console.log(findMovieByTitle("Star Wars"));
console.log("---------");

function displayFilteredMoviesByDirector(director) {
    let filteredMoviesByDirector = findMoviesByDirectorList(director);
    console.log(`Here's a list of all ${filteredMoviesByDirector.length} movies directed by ${director} that are available in the array:`);
    for (const movie of filteredMoviesByDirector) {
        console.log(movie.title);
    }
}

displayFilteredMoviesByDirector("Peter Jackson");
console.log("---------");
let filterDirectorList = findMoviesByDirectorList("Peter Jackson");

function findMovieInFilteredListByTitle(title) {
    return filterDirectorList.find(function (movie) {
        return movie.title.includes(title);
    });
}

let chosenMovie = findMovieInFilteredListByTitle("The Fellowship");

console.log(`Your first result came out to be: 
${chosenMovie.title}`);
console.log("---------");

function filterMovieByYear(year) {
...
function displayMoviesByYearList(year) {
  let moviesByYearList = filterMovieByYear(year);
  console.log(`Here's a list of movies released in the year ${year}: `);
  for (const movie of moviesByYearList) {
    console.log(`${movie.title}, Directed by ${movie.director}. (${movie.year})`);
  }
}

displayMoviesByYearList(1980);